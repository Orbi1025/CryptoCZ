(() => {
  ...
  async function d() {
    try {
      const t = document.querySelector(".tokenomics__ca"),
        e = document.getElementById("tokenValue").textContent.trim();
      t.classList.contains("ca-copied") ||
        (t.classList.add("ca-copied"),
        setTimeout(() => {
          t.classList.remove("ca-copied");
        }, 2600)),
